...
helm-push: helm-package  ## Push helm chart to local OCI registry
	helm push molior-$(MOLIOR_VERSION).tgz oci://$(PUSH_REGISTRY)/charts

helm-package:  ## Build helm package
	helm package charts/
